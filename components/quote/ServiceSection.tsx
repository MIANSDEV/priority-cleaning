...
export default function ServiceSection({ category, selected, onUpdate }: Props) {
  ...
  // Keyed by (item_id, level_id) — each combo is independent
  ...
  // For checkbox items (single level)
  ...
  return (
    <div className="mb-4 border border-gray-200 rounded overflow-hidden shadow-sm">
      ...
      >
        ...
        <span className="bg-brand text-white p-1 rounded flex items-center justify-center">
